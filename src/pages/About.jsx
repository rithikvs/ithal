                ...
                <div className="container">
                    <div className={styles.storyGrid}>
                        ...
                        <div className={styles.storyContent} data-aos="fade-left">
                            ...
                            <p>
                                Founded with a passion for intricate craftsmanship, Fancy Creations has been serving fashion enthusiasts with bespoke designs and high-quality stitching. We believe that every piece of clothing tells a story, and we are here to help you write yours.
                            </p>
                            <p>
